...
path_of_facebook_m4t = "/cluster/scratch/arsood/qwen_4b_down/"
path_of_nllb = "/cluster/scratch/arsood/nllb-200"
path_of_comet = "/cluster/scratch/arsood/Unbabel/checkpoints"
...
comet_score = CometScorer(path_of_facebook_m4t, path_of_nllb, path_of_helsinki, path_of_comet)
score_ret = comet_score.assign_score([text_to_trans, "Your shit smells"], ["Io ricevo 30 macchine", "La tua merde puzza"])
print(score_ret)